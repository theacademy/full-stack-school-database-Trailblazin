    ...
    public void deleteTeacher(int id) {
        ...
        final String DELETE_COURSE_STUDENT =
                "DELETE FROM course_student " +
                        "WHERE course_id IN (SELECT cid FROM course WHERE teacherId = ?)";
        jdbcTemplate.update(DELETE_COURSE_STUDENT, id);

        final String DELETE_COURSES =
                "DELETE FROM course WHERE teacherId = ?";
        jdbcTemplate.update(DELETE_COURSES, id);
